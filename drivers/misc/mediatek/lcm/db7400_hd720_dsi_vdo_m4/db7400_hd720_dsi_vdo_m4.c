...
extern void sm5107_dsv_ctrl(int enable);
extern void sm5107_dsv_toggle_ctrl(void);
...
static LCM_setting_table_V3 lcm_initialization_setting_V3[] = {
	...
	{0x29, 0xB5, 51, {0x19, 0x04, 0x1C, 0x22, 0x2F, 0x80, 0x2F, 0x1F, 0x04, 0x40,
	                  0x05, 0x00, 0x20, 0x09, 0x04, 0x40, 0x05, 0x00, 0xA5, 0x0D,
					  0x2F, 0x2F, 0x3F, 0xFF, 0x3F, 0xFF, 0x01, 0x7C, 0x00, 0x02,
	...
	{0x29, 0xBB, 15, {0x00, 0x90, 0x90, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	{0x29, 0xD7, 26, {0x00, 0x13, 0xFF, 0x39, 0x0B, 0x04, 0x14, 0xF4, 0x01, 0x00,
	                  0x00, 0x00, 0x00, 0x60, 0x01, 0x57, 0x57, 0x41, 0x28, 0x28,
					  0x3F, 0x00, 0x00, 0x00, 0x00, 0x00}}, //Touch GIP control
	{0x29, 0xF5,  5, {0x00, 0x06, 0x00, 0x00, 0x80}}, //Touch LFD control
	{0x15, 0xF6,  1, {0x06}}, //VDD1 Set
	{0x29, 0xF0, 35, {0x18, 0x00, 0x14, 0x14, 0x00, 0x0B, 0x0B, 0x16, 0x0B, 0x19,
	                  0x41, 0x16, 0x17, 0x69, 0x6E, 0x73, 0x78, 0xBC, 0xC1, 0xC6,
	                  0xB0, 0xB0, 0xAF, 0xB0, 0xAD, 0x85, 0xB0, 0xB0, 0x5D, 0x58,
	...
	{0x29, 0x85, 25, {0x11, 0x6E, 0x22, 0x5A, 0x19, 0x44, 0x28, 0x7F, 0x4D, 0xAD,
                      0x85, 0x62, 0xA2, 0x9B, 0x8C, 0x65, 0x51, 0x97, 0x60, 0xB0,
                      0x9C, 0x65, 0x51, 0xA5, 0x62}}, //Color Enhance Control
...
static void lcm_get_params(LCM_PARAMS * params)
{
	...
	params->dsi.vertical_frontporch = 540;
...
static void init_lcm_registers(void)
{
	...
	LCM_PRINT("[LCD] init_lcm_registers S \n");
	...
	LCM_PRINT("[LCD] init_lcm_registers E \n");
}
...
void init_lcm_registers_sleep_2nd(void)
{
#if 0
	unsigned int data_array[1];
	LCM_PRINT("[LCD] init_lcm_registers_sleep_2nd S \n");
	...
	MDELAY(120);
	LCM_PRINT("[LCD] init_lcm_registers_sleep_2nd E \n");
#else
	MDELAY(20);
...
static void init_lcm_registers_sleep_out(void)
{
	...
	LCM_PRINT("[LCD] init_lcm_registers_sleep_out S \n");
	...
	dsi_set_cmdq(data_array, 1, 1);
	MDELAY(50);
	LCM_PRINT("[LCD] init_lcm_registers_sleep_out E \n");
}
...
static void lcm_init(void)
{
	...
	MDELAY(120);
	need_set_lcm_addr = 1;
	LCM_PRINT("[LCD] lcm_init E \n");
}

static void lcm_suspend(void)
{
	LCM_PRINT("[LCD] lcm_suspend S \n");

	init_lcm_registers_sleep();
	sm5107_dsv_toggle_ctrl();

	LCM_PRINT("[LCD] lcm_suspend E \n");
}
...
{
	LCM_PRINT("[LCD] lcm_resume_power S \n");
...
//	ldo_p5m5_dsv_5v5_off();
	...
	LCM_PRINT("[LCD] lcm_resume_power E \n");
}

static void lcm_resume(void)
{
	LCM_PRINT("[LCD] lcm_resume S \n");
	lcm_init();
	need_set_lcm_addr = 1;
	LCM_PRINT("[LCD] lcm_resume E \n");
}

static void lcm_esd_recover(void)
{
	LCM_PRINT("[LCD] lcm_esd_recover S \n");

	lcm_suspend();
	MDELAY(20);
	lcm_resume();

	LCM_PRINT("[LCD] lcm_esd_recover E \n");
}
