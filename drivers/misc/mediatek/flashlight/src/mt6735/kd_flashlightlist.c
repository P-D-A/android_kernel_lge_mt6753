...
//[LGE_UPDATE_S][kyunghun.oh@lge.com][2015-12-23] Disable battery check for system UI flash(UX scenario of battery level under 15% : cameraApp flash = off, systemUI flash = on)
#if 0
...
#endif
//[LGE_UPDATE_E][kyunghun.oh@lge.com][2015-12-23] Disable battery check for system UI flash(UX scenario of battery level under 15% : cameraApp flash = off, systemUI flash = on)
