...
void PMIC_EINT_SETTING(void)
{
	...
	// LGE_CHANGE, remove warning(Unbalanced enable for IRQ)
	...
	if (node) {
		...
		// LGE_CHANGE, power key does not work when UART log enabled
...
#if defined(TARGET_MT6735_M1V) || defined(TARGET_MT6735_K6)
	/* [12:12]: RG_VM_FAST_TR;*/
